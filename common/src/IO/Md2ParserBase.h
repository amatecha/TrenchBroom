...
#ifndef TrenchBroom_Md2ParserBase
#define TrenchBroom_Md2ParserBase
...
namespace TrenchBroom {
    ...
    namespace IO {
        ...
        class Md2ParserBase : public EntityModelParser {
        protected:
        ...
        protected:
            Md2ParserBase(const String& name, const char* begin, const char* end, const Assets::Palette& palette, const FileSystem& fs);
            virtual ~Md2ParserBase();
        protected:
            Md2SkinList parseSkins(CharArrayReader reader, const size_t skinCount);
            Md2FrameList parseFrames(CharArrayReader reader, const size_t frameCount, const size_t frameVertexCount);
            Md2MeshList parseMeshes(CharArrayReader reader, const size_t commandCount);
...
#endif /* defined(TrenchBroom_Md2ParserBase) */
